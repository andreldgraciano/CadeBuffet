class EventsController < ApplicationController
  ...
  def event_params
    params.require(:event).permit(:name, :description, :min_people, :max_peaple, :duration, :base_price, :additional_per_person, :extra_hour, :base_price_weekend, :additional_per_person_weekend, :extra_hour_weekend, :menu, :address, :venue_preference, :alcoholic_drink, :decoration, :parking)
  end
